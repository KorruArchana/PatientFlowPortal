<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QuestionaireRep.aspx.cs" Inherits="EMIS.PatientFlow.Web.ReportModule.QuestionnaireReport.QuestionaireRep" Async="true"  %>
    ...
    <script>
      (function (i, s, o, g, r, a, m) {
        ...
        function ViewReports() {
            ...
            if ($("#OrganisationId").val() != null && $("#KioskId").val() != null && $("#txtFromDate").val() != '' && $("#txtToDate").val() != '') {
                sendEventDetails('event type', 'Reports', 'Questionnaire Report Viewed', 'Report Viewed');
            }
            return false;
        }


        function sendEventDetails(eventtype, name, action, detail) {
            if (eventtype != '') {
...
<body>
    <form id="form1" runat="server">
      <asp:ScriptManager ID="ScriptManagerQuestionnaireReport" runat="server" EnablePartialRendering="true" ></asp:ScriptManager>
       ...
       <asp:UpdatePanel ID="UpdatePanelQuestionnaireReport" runat="server" UpdateMode="Always">
        <ContentTemplate>
       <asp:Label ID="lbError" runat="server" class="validation-summary-errors" Text="All fields are mandatory *"></asp:Label>

                <rsweb:ReportViewer ID="ReportViewerQuestionnaireReport" runat="server"
