...
namespace EMIS.PatientFlow.SyncService.Helper
{
	public class CustomDelegatingHandler : DelegatingHandler
	{
		...
		internal string AppId = Utility.GetAppSettingValue("ProductKey");
		...
		private string GenerateAPIKey()
		{
			...
			//return "A93reRTUJHsCuQSHR+L3GxqOJyDmQpCgps102ciuabc=";
		}
		...
		private string GeneratePassword(string productId)   // case matter for product id
		{
			...
			string commonName = "patientflowsyncserviceunqiuevalue".EncryptAES256();   // different value for Sync
