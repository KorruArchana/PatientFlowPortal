...
{
    public sealed class PcsClient : IDisposable
    {
        ...
        public PcsClient(Credential credential)
        {
            ...
            out string message)
        {
            ...
            message = GetOutcomeMessage(Enums.ApiMethod.Initialise, Convert.ToInt32(outcome));
        ...
        private bool GetLoginId(string ip, string organisationId, string supplierId, out string loginId, out string message)
        {
            ...
            message = GetOutcomeMessage(Enums.ApiMethod.Logon, Convert.ToInt32(outcome));
        ...
        private string GetOutcomeMessage(Enums.ApiMethod method, int outcome)
        {
        ...
        public ApiResult<PCSAppointmentSessions.AppointmentSessionList> GetAppointmentSessions(string startDate, string endDate, string slotType)
        {
            ...
            var result = GetApiResult<PCSAppointmentSessions.AppointmentSessionList>(
                Enums.ApiMethod.GetAppointmentSessions,
        ...
        public ApiResult<PCSSlotList.SlotList> GetSlotForSessions(int appointmentSessionId)
        {
            object error, outcome, slots;

            _client.GetSlotsForSession(_sessionId, appointmentSessionId, out slots, out error, out outcome);

            var result = GetApiResult<PCSSlotList.SlotList>(
                Enums.ApiMethod.GetSlotForSessions,
        ...
        public ApiResult<Slot> BookAppointment(Appointment appointment)
        {
            ...
            ApiResult<Slot> result = GetApiResult<Slot>(
                Enums.ApiMethod.BookAppointment,
        ...
        public ApiResult<PCSUserDetails.UserDetails> GetCurrentUser()
        {
            ...
            ApiResult<PCSUserDetails.UserDetails> result = GetApiResult<PCSUserDetails.UserDetails>(
                Enums.ApiMethod.GetCurrentUser,
        ...
        public ApiResult<PCSAppointmentConfiguration.AppointmentConfiguration> GetAppointmentConfiguration(string startDate, string endDate)
        {
            object error, outcome, appointmentConfiguration;

            _client.GetAppointmentConfiguration(_sessionId, startDate, endDate,  out appointmentConfiguration, out error, out outcome);

            var result = GetApiResult<PCSAppointmentConfiguration.AppointmentConfiguration>(
                Enums.ApiMethod.GetAppointmentConfiguration,
        ...
        public ApiResult<string> SavePatientSurvey(string accessPassword, string patientId, string medicalRecord, string attachmentPath)
        {
            ...
            ApiResult<string> result = GetApiResult<string>(
                Enums.ApiMethod.FileRecord,
                string.Empty,
                Convert.ToInt32(outcome),
                Convert.ToString(error));
		...
		public ApiResult<BookedPatients> GetArrivedPatients(
			int within,
			int before)
		{
			object error, outcome, patients;
		...
		public ApiResult<BookedPatients> GetSentInPatients(
			int within,
			int before)
		{
			object error, outcome, patients;
		...
		public ApiResult<PCSPatientsAppointmentList.PatientAppointmentList> GetPatientAppointments(string patientId)
		{
			...
			var result = GetApiResult<PCSPatientsAppointmentList.PatientAppointmentList>(
